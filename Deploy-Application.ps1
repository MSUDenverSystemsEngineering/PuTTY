...
Try {
	...
	[string]$appVersion = '0.73'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '06/18/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'putty,puttytel,pscp,psftp,plink,pageant,puttygen' -CheckDiskSpace -PersistPrompt
